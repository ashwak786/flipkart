...
import redbus.core.api
import redbus.core.createComponents
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = redbus.core.api as Api<T>
    override val config: ApplicationConfig = redbus.core.config
}
